...
import com.pairlearning.expensetrackingapi.repositories.TransactionRepository;
...
public class TransactionServiceIml implements TransactionService {
    ...
    @Override
    public void updateTransaction(Integer userId, Integer categoryId, Integer transactionId, Transaction transaction) throws
